...
\author[1]{Danilo Canivel\thanks{\texttt{d.canivel@gmail.com} · \url{https://www.linkedin.com/in/canivel/} · Code: \url{https://github.com/canivel/technical-ai-safety}}}
...
precision with eager attention on an NVIDIA H100 (80\,GB).
...
All experiments were run on RunPod cloud GPUs (NVIDIA H100, 80\,GB).
